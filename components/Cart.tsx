      ...
      <div className="sm:flex shadow-md my-10">
        ...
        <div className="w-full sm:w-3/4 bg-[hsl(var(--card))] px-10 py-10">
          ...
          <div className="flex justify-between border-b border-[hsl(var(--border))] pb-8">
            ...
            <h2 className="font-semibold text-lg sm:text-2xl">3 Items</h2>
          </div>

          {/* Cart Item */}
          <div className="md:flex items-stretch py-8 md:py-10 lg:py-8 border-t border-[hsl(var(--border))]">
            ...
            <div className="md:pl-3 md:w-8/12 2xl:w-3/4 flex flex-col justify-center">
              <p className="text-xs sm:text-sm leading-3 text-[hsl(var(--card-foreground))] md:pt-0 pt-4">
                RF293
              </p>
              ...
              <p className="text-xs sm:text-sm leading-3 text-[hsl(var(--muted-foreground))] py-4">
                Color: Black
              </p>
              <p className="w-96 text-xs sm:text-sm leading-3 text-[hsl(var(--muted-foreground))]">
              ...
              <div className="flex items-center justify-between pt-5">
                <div className="flex items-center">
                  ...
                  <p className="text-xs sm:text-sm leading-3 underline text-red-500 pl-5 cursor-pointer">
                    Remove
                  </p>
                </div>
                <p className="text-base sm:text-lg font-black leading-none text-[hsl(var(--card-foreground))]">
          ...
          {/* ... You can duplicate the above cart item block for additional items ... */}
        ...
        >
          ...
          <div className="flex justify-between mt-10 mb-5">
            ...
            <span className="font-semibold text-sm sm:text-base">$590</span>
          </div>
          <div>
